...
DOCKER_BUILD_IMAGES := \
	...
	kube-events-collector:$(PROJECT_DIR)/cmd/kube-events-collector/Dockerfile:$(PROJECT_DIR)
...
docker.build.kube-events-collector: go.build-multiarch.kube-events-collector
